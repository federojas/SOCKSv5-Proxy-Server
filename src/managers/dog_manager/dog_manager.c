...
static void get_cmd_conc_conn_handler(dog_response * dog_response, dog_request dog_request);
static void get_cmd_bytes_transf_handler(dog_response * dog_response, dog_request dog_request);
static void get_cmd_is_sniffing_handler(dog_response * dog_response, dog_request dog_request);
static void get_cmd_is_auth_handler(dog_response * dog_response, dog_request dog_request);
static void get_cmd_user_page_size(dog_response * dog_response, dog_request dog_request);
static void alter_cmd_add_user_handler(dog_response * dog_response, dog_request dog_request);
static void alter_cmd_del_user_handler(dog_response * dog_response, dog_request dog_request);
static void alter_cmd_toggle_sniffing_handler(dog_response * dog_response, dog_request dog_request);
static void alter_cmd_toggle_auth_handler(dog_response * dog_response, dog_request dog_request);
...
void manager_passive_accept(struct selector_key *key) {
    ...
    if(dog_manager.dog_response.dog_status_code == SC_OK) {
        if(dog_manager.dog_request.dog_type == TYPE_GET)
            get_handlers[dog_manager.dog_request.current_dog_cmd](&dog_manager.dog_response, dog_manager.dog_request);
        else
            alter_handlers[dog_manager.dog_request.current_dog_cmd](&dog_manager.dog_response, dog_manager.dog_request);
    }
